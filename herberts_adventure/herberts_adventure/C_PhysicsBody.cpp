...
void C_PhysicsBody::Init(C_GameObject& game_object, const float mass, const bool is_kinematic, const float density, const float friction, const float bounciness)
{
	...
	//}
	body_ = game_object.world()->CreateBody(game_object, mass, is_kinematic, density, friction, bounciness);
